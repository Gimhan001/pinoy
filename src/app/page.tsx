...
export default function Home() {
  return (
    <main className="">
      ...
      <div className="bg-slate-100  lg:-mt-40 lg:mb-24 z-40 lg:p-20 sm:p-4 rounded-br-3xl rounded-bl-3xl">
      ...
      <div className="container mx-auto px-4 mt-8">
        ...
        <div className="round-trip mt-8 bg-slate-100 p-4 rounded-3xl">
        ...
        <div className="mt-16 bg-slate-100 p-4 rounded-3xl">
